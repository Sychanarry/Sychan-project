...
class _ProductEditState extends State<ProductEdit> {
  ...
  Future<void> _fetchProductDetails() async {
    final response = await http.get(Uri.parse('https://store.annymarket.shop/public/api/product/${widget.productId}'));
  ...
  Future<void> _updateProduct() async {
    final url = Uri.parse('https://store.annymarket.shop/public/api/product/${widget.productId}');
          ...
          child: Column(
            children: <Widget>[
              TextFormField(
                ...
                decoration: InputDecoration(labelText: 'ຊື່ໂທລະສັບ'),
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'ກະລຸນາປ້ອນຊື່ໂທລະສັບ';
                  }
                  return null;
                },
              ),
