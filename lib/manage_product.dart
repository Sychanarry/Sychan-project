...
Future<List<get_Product>> fetchProducts() async {
  final response = await http.get(Uri.parse('https://store.annymarket.shop/public/api/product'));
...
Future<void> deleteProduct(int id) async {
  final response = await http.delete(
    Uri.parse('https://store.annymarket.shop/public/api/product/$id'),
